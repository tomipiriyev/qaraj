...
SOCIAL_SVGS = {
    "Telegram": '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.9 4.3 18.9 19c-.2 1-.8 1.2-1.7.8l-4.6-3.4-2.2 2.1c-.3.3-.5.5-1 .5l.3-4.7 8.5-7.7c.4-.3-.1-.5-.6-.2L7.2 13 2.7 11.6c-1-.3-1-1 .2-1.5l17.7-6.8c.8-.3 1.5.2 1.3 1Z"/></svg>',
    "VK": '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.8 17c-5 0-8.2-3.5-8.3-9.3h2.6c.1 4.3 2.1 6.1 3.6 6.5V7.7h2.5v3.8c1.4-.2 2.9-1.9 3.4-3.8h2.4c-.4 2.3-1.9 4-3 4.7 1.1.6 2.8 2.1 3.5 4.6h-2.7c-.5-1.7-1.8-3-3.6-3.2V17h-.4Z"/></svg>',
    "Instagram": '<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor" stroke-width="1.7"/><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="1.7"/><circle cx="17.5" cy="6.5" r="1.2" fill="currentColor"/></svg>',
}

SOCIALS = "".join(
    f'<a href="#" aria-label="{name}">{svg}</a>' for name, svg in SOCIAL_SVGS.items())
  ...
  <div class="wrap">
    <div class="foot-cols">
      <div class="foot-col">
        ...
        <a href="/#ways">Способы аренды</a>
        <a href="/#why">Безопасность</a>
      </div>
      <div class="foot-col">
        <h5>Хозяевам</h5>
        ...
        <a href="/#owners">Разместить место</a>
      </div>
      <div class="foot-col">
        <h5>Qaraj</h5>
        <a href="/">О сервисе</a>
    ...
    <div class="foot-blog">
      <div class="foot-cols foot-cols-4">
{blog_columns()}
      </div>
    </div>
    <div class="foot-bottom">
      <div class="foot-legal">
        <span>© 2026 Qaraj</span>
